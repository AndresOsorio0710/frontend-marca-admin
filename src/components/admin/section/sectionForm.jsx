...
function SectionForm({data, isEdit, handleAddOrEdit}) {

    const handleSubmit = (dataSection, {resetForm}) => {
        handleAddOrEdit(dataSection);
    ...
    return (
        <div className={'panel shadow'}>
            <div className={'header'}>
                {isEdit ? (
                    <h2 className={'title'}>
                        <i className={'fas fa-edit'}/> Editar Sección
                    </h2>
                ) : (
                    <h2 className={'title'}>
                        <i className={'fas fa-plus'}/> Agregar Sección
                    </h2>
                )}
            </div>
            <div className={'inside'}>
                <form onSubmit={formik.handleSubmit}>
                    <label>Nomber se la sección:</label>
